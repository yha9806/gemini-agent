...
- `telemetry report` combines aggregate health, economics, context reuse, attribution, multimodal adoption, visual gate final-outcome scope, and top development priority into a product decision snapshot; it does not print raw prompt, response text, event ids, batch ids, paths, or media file names.
