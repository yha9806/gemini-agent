...
- Telemetry summary and report aggregate artifact-review design scorecard metrics from safe numeric metadata without exposing scorecard text, raw prompts, raw responses, event ids, paths, or media file names.
